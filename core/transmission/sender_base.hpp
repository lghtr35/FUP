    ...
    namespace core
    {
        namespace transmission
        {
            ...
            public:
                ...
                virtual int send_packet(boost::shared_ptr<boost::asio::ip::udp::socket> handler, fup::core::entity::packet *packet) const = 0;
                // Through TCP to notify server if any datagram is missing
                virtual int send_resend(boost::shared_ptr<boost::asio::ip::tcp::socket> handler, int packageNumber) const = 0;
                // Plan is to do this via TCP at the beginning to have Metadata on server and clients
                virtual int send_metadata(boost::shared_ptr<boost::asio::ip::tcp::socket> handler, fup::core::entity::metadata *metadata) const = 0;
                ...
                virtual int send_key(boost::shared_ptr<boost::asio::ip::tcp::socket> handler, std::string key) const = 0;
