...
#include "upload_download_manager.hpp"
...
namespace fup
{
    namespace facade
    {
        namespace manager
        {
            void upload_download_manager::download_file(fup::core::connection *&connection, fup::core::interface::checksum *&checksum_service, std::fstream *&file)
            {
            ...
            void upload_download_manager::upload_file(fup::core::connection *&connection, fup::core::interface::checksum *&checksum_service, file_manager *&file_manager, std::fstream *&file)
            {
